...
// unmount explicitly or renders leak across tests and queries hit duplicates.
afterEach(cleanup);
...
test("the denied card points at OS-level privacy settings, not just the browser", async () => {
