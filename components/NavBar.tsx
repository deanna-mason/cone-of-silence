...
export default function NavBar() {
  return (
    <nav className="hairline sticky top-0 z-40 border-b bg-noir/85 backdrop-blur-sm">
      <div className="mx-auto flex max-w-3xl items-center justify-between gap-4 px-6 py-4">
        <Link href="/" className="group flex items-center gap-3">
          ...
          <span className="font-display text-2xl leading-none tracking-[0.12em] text-paper">
            CONE OF SILENCE
          </span>
        </Link>

        <div className="flex items-center gap-5 text-paper-dim">
          <Link
            href="/"
